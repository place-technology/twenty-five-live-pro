module TwentyFiveLivePro
  module API
    class Spaces
      ...
      def list(page : Int32 = 1, items_per_page : Int32 = 10, since : String? = nil, paginate : String? = nil)
        io = IO::Memory.new
        builder = ParameterBuilder.new(io)
      ...
      def availability(id : Int32, start_date : String, end_date : String, included_elements : Array(String), expanded_elements : Array(String))
        ...
        Models::SpaceAvailabilityResponse.from_json(@session.post("/spaceAvailability.json?#{io.rewind}", raw: body.to_json).body)
      end
    end
  end
end
